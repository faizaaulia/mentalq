	...
	<div class="container mt-4">
		...
		<div class="row mt-3">
			<div class="kartu m-auto">
				<div class="card">
					<a class="showModal" href="<?= base_url('Consultant/showConsultant/').$consultant->noSTR?>"
						data-toggle="modal">
						...
						<div class="card-body">
							...
							<p style="color: #bdbdbd;"><img src="<?= base_url('assets/img/BRIEFCASE ICON.png')?>" style="width:4%; margin-top: 5px; margin-right: 5px;"><?= $consultant->lamaPsikologi ?>
							</p>
						</div>
					</a>
				</div>
		...
		<div class="modal fade bd-Doc1-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
				...
				<div class="modal-content">
					<div class="modal-body">
						...
						<div class="container">
							...
							<div class="row">
								<div class="col-md-7">
									<p class="namaConsultant" style="font-size: 32px; color: #454545; margin-top: 5px;">
									</p>
									<p class="jenisPsikologi"></p>
									<p class="lamaPsikologi"
										style="color: #bdbdbd; margin-top: -20px; font-size: 23px;"><img src="<?= base_url('assets/img/BRIEFCASE ICON.png')?>" style="width:10%; margin-top: 5px; margin-right: 5px;"></p>
									<p>Work Place</p>
